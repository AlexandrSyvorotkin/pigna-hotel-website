...
import img10 from "../../assets/project-timeline/newmanimg.png";
...
const slidesEls = [
  {
    ...
    date: 1200,
    textIt:
      "Una leggenda narra che un contadino, passando vicino al Lago Pigo con il suo asino affetto da eczema, guarì l’animale grazie all’effetto benefico delle acque, che divennero famose nella regione per secoli.",
  },
  {
    img: img2,
    ...
    date: 1365,
    textIt:
      "Una storica pace fu firmata tra due fazioni sul ponte del Lago Pigo a Pigna, accanto alle sorgenti sulfuree, che divennero la linea di confine tra i territori della Provenza e della Repubblica di Genova. Oggi, il Grand Hotel Pigna è situato proprio accanto allo storico ponte.",
  },
  {
    img: img3,
    ...
    date: 1839,
    textIt:
      "Fu eseguita un’analisi chimica delle acque, che rilevò la presenza di zolfo e probabilmente idrosolfiti, acido carbonico, solfato di soda, carbonato di soda, cloruro di sodio, tracce di carbonato di magnesio e una sostanza organica azotata.",
  },
  {
    img: img4,
    ...
    date: 1884,
    textIt:
      "Iniziò lo sfruttamento commerciale delle benefiche acque termali. In questo periodo Claude Monet visitò i dintorni di Pigna — il piccolo borgo di Dolceacqua. Così impressionato da questo ponte medievale, lo definì una “perla di leggerezza” e lo ritrasse nel dipinto “Il Ponte di Dolceacqua”.",
  },
  {
    img: img5,
    ...
    date: 1903,
    textIt:
      "Fu aperto il primo vero stabilimento balneare a Pigna. L’acqua veniva prelevata da un pozzo presumibilmente con secchi legati a una corda, calati lungo una cavità naturale rinforzata internamente con mattoni e issati per circa venti metri.",
  },
  {
    img: img6,
    ...
    date: 1920,
    textIt:
      "Dopo la Grande Guerra, la parte inferiore dei complessi del mulino fu quasi interamente distrutta. Solo dopo la Seconda Guerra Mondiale, Giovanni Battista Manesero, proprietario della sorgente, rilanciò l’idea di utilizzare adeguatamente le acque sulfuree della zona.",
  },
  {
    img: img7,
    ...
    date: 1954,
    textIt:
      "Fu costruita la prima spa termale a Pigna — stanze con vasche dove era possibile immergersi nell’acqua sulfurea. All’epoca erano circa 3.000 i turisti italiani e stranieri, per lo più francesi, che visitavano il complesso termale. Tra i clienti famosi vi erano il tenore Di Stefano e la Principessa Grace. I bagni di acqua solfurea operarono a pieno regime fino al 1989.",
  },
  {
    img: img8,
    ...
    date: 2000,
    textIt:
      "Fu costruito e gestito come hotel termale moderno a 4* — il Grand Hotel Antiche Terme di Pigna.",
  },
  {
    img: img9,
    ...
    date: 2020,
    textIt:
      "Dopo il cambio di proprietà dell’hotel, fu creato un nuovo concetto di rifugio termale di lusso a 5* — il Grand Hotel Pigna.",
  },
  {
    img: img10,
    ...
    date: 2022,
    textIt:
      "Dopo il cambio di proprietà dell’hotel, fu creato un nuovo concetto di rifugio termale di lusso a 5* — il Grand Hotel Pigna.Un raffinato concept per il design degli interni e la ristrutturazione del Grand Hotel Pigna fu ideato da Alex Kravetz.",
  },
  {
    img: img11,
    ...
    date: 2024,
    textIt:
      "Sono stati completati i documenti di approvazione, le ricerche e i lavori di pianificazione. Il progetto è in fase di raccolta investimenti per l’attuazione dei piani di ristrutturazione.",
  },
];
  ...
  return (
    ...
    >
        <div className="w-full flex justify-center items-center flex-col gap-4 text-main-white">
          ...
          <span className="text-responsive font-helvetica font-normal opacity-80 text-center">
            {locale === "ENG"
              ? "From mediaeval past to a premium wellness destination of the future."
              : "Dal passato medievale a una destinazione benessere premium del futuro."}
          </span>
        </div>
        <div className="w-full flex justify-center items-center lg:pl-[84px] sm:pl-[18px] md:pl-40px">
          <div
            className="w-full mt-10 px-2 overflow-hidden sm:pb-2 md:mb-0"
            id="project-timeline-swiper"
          >
            <Swiper
            ...
            >
              {slidesEls.map((slide, index) => (
                <SwiperSlide
                  key={index}
                  className="w-5/12 relative swiper-slider-element"
                >
                  <Image
                    src={slide.img}
                    alt={slide.text}
            ...
            <div
              className="w-full h-[1px] lg:mt-1 lg:mb-8 sm:mb-0 sm:mt-40 md:mt-40"
              style={{
                background:
                  "linear-gradient(to right, #FFF 0%, #FFF 70%, rgba(255, 255, 255, 0) 100%)",
              }}
            ></div>
          </div>
        </div>
        ...
        <div className="lg:mt-36 sm:mt-10 w-full flex justify-center">
          <div className="w-full">
            <div className="flex flex-col gap-4 w-full">
              <span className="text-main-white font-helvetica font-normal text-2xl text-center uppercase">
                {locale === "ENG"
                  ...
                  : "Stato del progetto. Documenti e permessi ottenuti"}
              </span>
              <div className="w-full flex justify-center items-center">
                <p className="text-main-white font-helvetica font-normal text-lg text-center mt-3 opacity-80 lg:w-[42%] sm:w-full">
                  {locale === "ENG"
                    ? " The approval documentation, research and planning work have been completed. The project is at the stage of raising investment forthe implementation of the renovation plans:"
            ...
            <div className="xl:hidden flex-col gap-4 md:flex">
              {textItems.map((text, index) => (
                <div key={index} className="flex flex-col gap-4">
                  <p className="text-main-white font-helvetica font-normal text-responsive w-full">
                    {locale === "ENG" ? text.eng : text.it}
                  </p>
                  {index < textItems.length - 1 && (
                    <div className="h-[1px] w-[24px] bg-main-white opacity-30 sm:mb-4 md:mb-0" />
                  )}
                </div>
              ))}
            </div>
