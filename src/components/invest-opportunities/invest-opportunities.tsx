          ...
          <div className="flex flex-col gap-4 lg:w-3/4 sm:w-full">
            ...
            {locale === "ENG" ? (
              <p className="lg:text-lg sm:text-xs font-helvetica font-normal text-center">
                ...
                combines the charm of the past with modern luxury. As the only
                resort in the region with exclusive spa and medical treatments,
                it is poised to become a key attraction for affluent visitors
                year-round. This project is a secure investment with a mid-range
                return. Investing in the project is a unique and exciting
                opportunity with the potential to be developed into a
                world-class medical spa and a grand hotel.
              </p>
            ) : (
              <p className="lg:text-lg sm:text-xs font-helvetica font-normal text-center">
                Situato in un’area storica, questo esclusivo resort termale
                unisce il fascino del passato al lusso moderno. Essendo l’unico
                resort nella regione con trattamenti spa e medici esclusivi, è
                destinato a diventare un’attrazione chiave per i visitatori
                facoltosi tutto l’anno. Questo progetto rappresenta un
                investimento sicuro con un ritorno di medio termine. Investire
                nel progetto è un’opportunità unica ed entusiasmante, con il
                potenziale di svilupparsi in una medical spa di livello mondiale
                e in un grand hotel.
              </p>
            )}
          </div>
