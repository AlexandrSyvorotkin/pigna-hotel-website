...
const Cuisine = () => {
  return (
    <div className='w-full lg:mt-44 sm:mt-10 flex justify-center items-center px-[18px]' id="cuisine">
      <div className='w-[1750px]'>
        ...
        <div className='mt-64 w-full flex justify-between' id="building-territory">
          ...
          <div className='flex gap-6 w-[80%] flex-wrap justify-end'>
            {imgArr.map((item, index) => (
              <div className="flex flex-col gap-2 w-[48%]">
                <Image src={item.img} alt='img' className='w-full h-[327px]' key={index} />
                <p className='text-black-main text-[18px] font-helvetica font-normal w-full'>{item.text}</p>
              </div>
            ))}
          </div>
        </div>
