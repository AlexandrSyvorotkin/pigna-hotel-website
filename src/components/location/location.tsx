    ...
    <div className="lg:mt-60 sm:mt-20 w-full" id="location">
      <div className="w-full flex justify-center items-center flex-col gap-5 mb-14">
        ...
        <p className="lg:*:text-lg text-center lg:w-1/2 sm:text-xs sm:w-3/4">
          The hotel is situated in a secluded area that offers excellent
          transportation links, including a helipad. Nearby cities such as
          Genoa, Nice, and Monaco are easily accessible.
        </p>
      </div>
      ...
      <div className="mt-20 w-full flex justify-center items-center flex-col gap-10">
        ...
        <div className="xl:w-1/2 md:w-3/4 sm:w-11/12">
          <p className="lg:text-lg sm:text-xs text-center font-helvetica">
            The hotel is approximately 20 kilometres from the coast (Italian
            Riviera) and 35 kilometres from Sanremo, known for its festivals,
            casino, yacht harbour and a charming old town.With convenient access
            to major motorways and railway stations in Ventimiglia and Sanremo,
            the hotel offers well-developed connectivity, making it easy for
            guests to arrive by car or train.
          </p>
        </div>
        ...
        <div className="lg:mt-20 sm:hidden lg:block px-20 w-11/12 justify-center">
          <div className="flex gap-10 justify-between w-full">
            {airportsImgs.map((el, index) => (
              <div
                key={index}
                className="flex flex-col gap-6 justify-start items-center w-1/3"
              >
